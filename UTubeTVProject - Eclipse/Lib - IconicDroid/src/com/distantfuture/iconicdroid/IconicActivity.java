  ...
  private void initSamplesList() {
    ...
    sampleItems.add(new SampleItem("Entypo icons", new View.OnClickListener() {
      ...
      public void onClick(View v) {
        startActivity(IconicTypefaceActivity.createIntent(IconicActivity.this, IconicTypefaceActivity.ICON_TYPE_ENTYPO));
      }
    }));
    sampleItems.add(new SampleItem("Entypo Social icons", new View.OnClickListener() {
      @Override
      public void onClick(View v) {
        startActivity(IconicTypefaceActivity.createIntent(IconicActivity.this, IconicTypefaceActivity.ICON_TYPE_ENTYPO_SOCIAL));
      }
    }));
    sampleItems.add(new SampleItem("Font Awesome icons", new View.OnClickListener() {
      @Override
      public void onClick(View v) {
        startActivity(IconicTypefaceActivity.createIntent(IconicActivity.this, IconicTypefaceActivity.ICON_TYPE_FONT_AWESOME));
      }
    }));
    sampleItems.add(new SampleItem("Iconic icons", new View.OnClickListener() {
      @Override
      public void onClick(View v) {
        startActivity(IconicTypefaceActivity.createIntent(IconicActivity.this, IconicTypefaceActivity.ICON_TYPE_ICONIC));
      }
    }));

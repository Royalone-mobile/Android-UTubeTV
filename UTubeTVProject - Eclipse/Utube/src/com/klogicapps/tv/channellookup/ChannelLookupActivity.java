package com.klogicapps.tv.channellookup;
...
import com.klogicapps.tv.activities.StorageAccessActivity;
...
import com.klogicapps.tv.misc.DUtils;
import com.klogicapps.tv.misc.JSONHelper;
import com.klogicapps.tv.misc.Utils;
import com.klogicapps.tv.services.SubscriptionsServiceRequest;
  ...
  public boolean onOptionsItemSelected(MenuItem item) {
	...
	if (itemId == android.R.id.home) {
		if (!endFindOnBackButton())
          finish();
		return true;
	} else if (itemId == R.id.action_default_channels) {
		Content.instance().resetToDefaults();
	} else if (itemId == R.id.action_show_import_dialog) {
		importFile();
		return true;
	} else if (itemId == R.id.action_import_subscriptions) {
		importSubscriptions();
		return true;
	} else if (itemId == R.id.action_show_export_dialog) {
		exportFile();
		return true;
	}
